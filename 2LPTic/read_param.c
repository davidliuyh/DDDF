...
#define MAXTAGS 300
  ...
  strcpy(tag[nt], "UseWhiteNoiseInput");
  addr[nt] = &UseWhiteNoiseInput;
  id[nt] = INT;
  optional[nt++] = 1;

  strcpy(tag[nt], "ExportWhiteNoiseOnly");
  addr[nt] = &ExportWhiteNoiseOnly;
  id[nt] = INT;
  optional[nt++] = 1;

  strcpy(tag[nt], "WhiteNoiseFile");
  addr[nt] = WhiteNoiseFile;
  id[nt] = STRING;
  optional[nt++] = 1;
